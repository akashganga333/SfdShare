...
public class userSignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sEmail=findViewById(R.id.loginemail);
        sPassword=findViewById(R.id.loginpassword);
        ...
        df.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot.getString("isstudent")!=null){
                    Toast.makeText(userSignIn.this,"Logged in Successfully",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(),studentDashboard1.class));
                    finish();
                }
                else if(documentSnapshot.getString("isprofessor")!=null){
                    Toast.makeText(userSignIn.this,"Logged in Successfully",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(),professorDashboard.class));
                    finish();
                }
                else{
                    Toast.makeText(userSignIn.this,"Wrong Email or Password entered",Toast.LENGTH_SHORT).show();
